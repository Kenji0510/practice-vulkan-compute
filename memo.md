...
```bash
============================================================
[0] NVIDIA Tegra Orin (nvgpu)  (IntegratedGpu)
  api_version        : 1.3.251
  driver_version     : 2264989696
  driver_name        : NVIDIA
  driver_info        : 540.4.0
  device_id/vendor_id: 2545550295/4318

-- Memory Heaps --
  heap[0]: size=61.37 GiB (65893163008 bytes), flags=DEVICE_LOCAL (DEVICE_LOCAL)
  heap[1]: size=872.00 MiB (914358272 bytes), flags=DEVICE_LOCAL (DEVICE_LOCAL)
  -> total DEVICE_LOCAL (approx VRAM): 62.22 GiB (66807521280 bytes)

-- Memory Types --
  type[0]: heap_index=0, property_flags=DEVICE_LOCAL
  type[1]: heap_index=0, property_flags=DEVICE_LOCAL | HOST_VISIBLE | HOST_COHERENT
  type[2]: heap_index=0, property_flags=DEVICE_LOCAL | HOST_VISIBLE | HOST_COHERENT | HOST_CACHED
  type[3]: heap_index=1, property_flags=DEVICE_LOCAL | PROTECTED

-- Key Limits / Sizes --
  max_buffer_size             : 1024.00 GiB (1099511562240 bytes)
  max_storage_buffer_range     : 4.00 GiB (4294967295 bytes)
  max_uniform_buffer_range     : 64.00 KiB (65536 bytes)
...
# Intel Xe GPU (i9-12900H, Windows 11)
```bash
============================================================
[1] Intel(R) Iris(R) Xe Graphics  (IntegratedGpu)
  api_version        : 1.4.323
  driver_version     : 1661866
  driver_name        : Intel Corporation
  driver_info        : 101.7082
  device_id/vendor_id: 18086/32902

-- Memory Heaps --
  heap[0]: size=7.99 GiB (8579665920 bytes), flags=DEVICE_LOCAL (DEVICE_LOCAL)
  -> total DEVICE_LOCAL (approx VRAM): 7.99 GiB (8579665920 bytes)
...
-- Key Limits / Sizes --
  max_buffer_size             : 4.00 GiB (4294967296 bytes)
  max_storage_buffer_range     : 1024.00 MiB (1073741820 bytes)
  max_uniform_buffer_range     : 128.00 MiB (134217724 bytes)
  max_push_constants_size     : 256
  max_memory_allocation_size  : 4.00 GiB (4294901760 bytes)
  max_memory_allocation_count  : 2127413

-- Compute / Workgroup ("__shared"-like) --
  max_compute_shared_memory_size : 32.00 KiB (32768 bytes)
  max_compute_work_group_invocations : 1024
  max_compute_work_group_size : [1024, 1024, 64] (x,y,z)
  max_compute_work_group_count: [65536, 65536, 65536] (x,y,z)
...
-- Floating-point atomics --
  shader_buffer_float32_atomic_add      : NO
  shader_buffer_float32_atomic_min_max  : YES
  shader_buffer_float64_atomic_add      : NO
  shader_buffer_float64_atomic_min_max  : NO
  shader_image_float32_atomic_add       : NO
  shader_image_float32_atomic_min_max   : NO
...
[0] NVIDIA GeForce RTX 3050  (DiscreteGpu)
  api_version        : 1.3.280
  driver_version     : 2350350336
  driver_name        : NVIDIA
  driver_info        : 560.94
  device_id/vendor_id: 9604/4318

-- Memory Heaps --
  heap[0]: size=5.86 GiB (6293553152 bytes), flags=DEVICE_LOCAL (DEVICE_LOCAL)
  heap[1]: size=7.99 GiB (8579665920 bytes), flags=empty()
  -> total DEVICE_LOCAL (approx VRAM): 5.86 GiB (6293553152 bytes)
